...
public class AddEditEmployeeBean {
     private int  hdnEmployeeId,ddlCountry,ddlState,ddlCity,rbStatus;
    private String txtUserName,txtPassword,txtName,txtDOB,rbGender,txtPhone,txtMobile,txtEmailID,taAddress,txtPinCode,txtDepartment,txtDesignation,txtDOJ,taOtherDetails;
    ...
    public int getHdnEmployeeId() {
        return hdnEmployeeId;
    }

    public void setHdnEmployeeId(int hdnEmployeeId) {
    ...
    public String getTaOtherDetails() {
        return taOtherDetails;
    }

    public void setTaOtherDetails(String taOtherDetails) {
        this.taOtherDetails = taOtherDetails;
    }
    ...
    public String getTxtDOJ() {
        return txtDOJ;
    }

    public void setTxtDOJ(String txtDOJ) {
        this.txtDOJ = txtDOJ;
    }
