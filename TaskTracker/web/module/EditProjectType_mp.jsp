...
<html>
    <head>
        ...
        <jsp:include page="stylesheet.jsp"/>
          <script type="text/javascript">
            function ValidateEditProjectTypeForm()
            {
            
                var strProjectType = document.getElementById("txtProjectType").value;
                if(isEmpty(strProjectType))
                    {
    ...
    <body class="internal">
        ...
        <div id="main">
            <div id="left">
                <jsp:include page="EditProjectType.jsp" />
            </div>
        </div>
        <div class="clr">
        </div>
