...
%>
<form action="#" method="post" onsubmit="return ValidateTaskSheetTeamMemberForm()">
                ...
                <table border="0" cellpadding="1" cellspacing="0">
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <fieldset> <legend><strong><em>Allocated Task</em></strong></legend>
                                ...
                                <table border="1" cellpadding="5" cellspacing="0" class="styled">
                                    ...
                                    <tr class="<%=cssClass%>">
                                        ...
                                        <td>
                                            <a href="EditTaskSheetTeamMember_mp.jsp?project_Id=<%=project_Id%>&projectTeam_Id=<%=projectTeam_Id%>&phase_Id=<%=phase_Id%>&projectTaskSheet_Id=<%=objBean.getProjectTaskSheet_Id()%>" >Update</a>
                                        </td>
                                    </tr>
                                    <%
                                        }
                    ...
                    <tr>
                        <td align="center" colspan="2">
                          ...
                          <input id="btnBackToWork"  class="button" value="Back to Work" name="btnBackToWork" onclick="window.location='WorkTeamMember_mp.jsp?project_Id=<%=project_Id %>'" type="button">&nbsp;
                        </td>
                    </tr>
                </table>
            </td>
