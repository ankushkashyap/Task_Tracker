...
<html>
    <head>
        ...
        <jsp:include page="stylesheet.jsp"/>
         <script type="text/javascript">
            function ValidateViewProjectDiscussionResponsesForm()
            {
            
                var strReply= document.getElementById("taReply").value;
                if(isEmpty(strReply))
                    {
                        alert("Enter Reply");
                        document.getElementById("taReply").focus();
                        return false;
                    }
    ...
    <body class="internal">
        ...
        <div id="main">
            <div id="left">
                <jsp:include page="ProjectDiscussionResponses.jsp" />
            </div>
        </div>
        <div class="clr">
        </div>
