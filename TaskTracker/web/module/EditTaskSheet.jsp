...
<%@page import="beans.module.AddEditTaskSheetBean"%>
...
<%
    ...
    int projectTaskSheet_Id = Integer.parseInt(request.getParameter("projectTaskSheet_Id"));
    ...
    AddEditTaskSheetBean objAETSB = obj.viewProjectTaskSheet(projectTaskSheet_Id);
    ...
    AddEditEmployeeBean objAEEB = objMES.viewEmployeeById(objAETSB.getDdlAssignTo());
    String d = "";
    if (objAEEB.getTxtDOJ() != null) {
        d = objAEEB.getTxtDOJ();
    }
%>
<form action="TaskSheetController.jsp" method="post" onsubmit="return ValidateEditTaskSheetForm()">
        ...
        <tr>
            <td >
                ...
                <table border="0" cellpadding="1" cellspacing="0">
                            ...
                            <fieldset>
                                ...
                                <table class="styledOuter" border="0" cellpadding="5" cellspacing="0" width="80%">
                                    ...
                                    <tr>
                                        ...
                                        <td >
                                            <input type="hidden" name="hdnProjectTaskSheet_Id" value="<%=projectTaskSheet_Id%>">
                                    ...
                                    <tr>
                                        ...
                                        <td >
                                            <input type="text" class="txtStyle" id="txtPhaseStartDate" name="txtStartDate" value="<%=objPPB.getStart_Date()%>" readonly="readonly"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td >
                                        ...
                                        <td >
                                            <input type="text" class="txtStyle" id="txtPhaseEndDate" name="txtEndDate" value="<%=objPPB.getEnd_Date()%>" readonly="readonly"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td >
                                    ...
                                    <tr>
                                        ...
                                        <td > <input type="hidden" name="hdnProjectTeam_Id" value="<%=projectTeam_Id%>">
                            ...
                            <fieldset>
                                ...
                                <table border="0" cellpadding="5" cellspacing="0" width="100%" class="styledOuter">                                
                                    <tr>
                                        ...
                                        <td><input  id="txtTask" name="txtTask" type="text" value="<%=objAETSB.getTxtTask()%>" class="txtStyle" /></td>
                                    </tr><tr>
                                        <td valign="top"><strong>Description</strong></td>
                                        <td><textarea  id="taDescription" name="taDescription" rows="2" cols="25"><%=objAETSB.getTaDescription()%></textarea></td>
                                    </tr>
                                    <tr>
                                            ...
                                            <select id="ddlAssignTo" name="ddlAssignTo" onchange="getEmployee(this.value)">
                                                ...
                                                <%
                                                    ...
                                                    for (int i = 0; i < empList.size(); i++) {
                                                        ...
                                                        String s = "";
                                                        if (objEmployeeBean.getUser_Id() == objAETSB.getDdlAssignTo()) {
                                                            s = "selected";
                                                        }
                                                %>
                                                <option <%=s%> value="<%=objEmployeeBean.getUser_Id()%>"><%=objEmployeeBean.getName()%></option>
                                            ...
                                            <div id="divEmp">
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input id="txtDOJ" name="txtDOJ" value="<%=d%>" type="text" readonly="readonly" class="txtStyle" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td><strong>Email Id</strong></td>
                                                        <td>
                                                            <input id="txtEmailId" name="txtEmailId" value="<%=objAEEB.getTxtEmailID()%>" type="text" readonly="readonly" class="txtStyle"/>
                                                        </td>
                                                        <td><strong>Phone</strong></td>
                                                        <td>
                                                            <input id="txtPhone" name="txtPhone" value="<%=objAEEB.getTxtPhone()%>" type="text" readonly="readonly" class="txtStyle"/>
                                                        </td>
                                                    </tr>
                                                </table>         
                                            </div>
                                            ...
                                            <select name="ddlPriority" id="ddlPriority">
                                                ...
                                                <%
                                                    for (int i = 0; i < prioritiesList.size(); i++) {
                                                        ...
                                                        if (objPBean.getIs_Active() == 1) {
                                                            String s = "";
                                                            if (objPBean.getPriority_Id() == objAETSB.getDdlPriority()) {
                                                                s = "selected";
                                                            }

                                                %>
                                                <option <%=s%> value="<%=objPBean.getPriority_Id()%>" ><%=objPBean.getTitle()%></option>
                                                ...
                                                <% if (statusList.size() > 0) {
                                                        for (int i = 0; i < statusList.size(); i++) {
                                                            ...
                                                            if (objBean.getIs_Active() == 1) {
                                                                String s = "";
                                                            if (objBean.getStatus_Id() == objAETSB.getDdlStatus()) {
                                                                s = "selected";
                                                            }
                                                %>
                                                <option value="<%=objBean.getStatus_Id()%>" <%=s%>><%=objBean.getTitle()%></option>
                                                <%
                                                            }
                                                        }
                                                    }
                                    ...
                                    <tr>
                                        <td><strong>Start Date</strong></td>
                                        <td>
                                            <input readonly="readonly"  id="txtStartDate" name="txtStartDate" value="<%=objAETSB.getTxtStartDate()%>" type="text" class="txtStyle"/>
                                        </td>
                                        <td><strong>End Date</strong></td>
                                        <td>
                                            <input readonly="readonly" id="txtEndDate" name="txtEndDate" value="<%=objAETSB.getTxtEndDate()%>" type="text" class="txtStyle"/>
                                        </td>
                                    </tr>
                    ...
                    <tr>
                        <td align="center">
                            <input type="submit" id="sbtnUpdate" name="sbtnUpdate" value="Update" class="button"/>&nbsp;
                            ...
                            <input onclick="window.location='TaskAllocation_ReportingHead_mp.jsp?project_Id=<%=project_Id%>'" class="button" id="btnBackToTaskAllocation" value="Back to Task Allocation" name="btnBackToTaskAllocation" type="button">&nbsp;    </td>
                    </tr>
                </table>
            </td>
        </tr>
